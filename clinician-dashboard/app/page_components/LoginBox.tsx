    ...
    return (
        <div className='m-20 p-10 px-20 border border-gray-300 rounded-sm'>
            ...
            <div className='text-center'>
                <p className="text-black dark:text-white">Any questions? <a className="underline text-blue-500 cursor-pointer" href="mailto:thi.riceapps@gmail.com">Contact us.</a></p>
            </div>
        </div>
    )
}

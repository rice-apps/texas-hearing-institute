		...
		>
			...
			>
				<Pressable
					style={({ pressed }) => [
						styles.circleButton,
						{ backgroundColor: 'red', width: 80, height: 80 },
						pressed ? styles.pressed : styles.circleButton,
					]}
				...
				<Pressable
					style={({ pressed }) => [
						styles.circleButton,
						{ backgroundColor: 'green', width: 80, height: 80 },
						pressed ? styles.pressed : styles.circleButton,
					]}
	...
	return (
		...
		<View>
			<Pressable
				style={({ pressed }) => [
					styles.circleButton,
					{ backgroundColor: '#cfcdcc', width: 40, height: 40 },
					pressed ? styles.pressed : styles.circleButton,
				]}
				onPress={startPlay}
			>
				<Icon name={isPlaying ? 'pause' : 'play'} size={20} color="black" />
			</Pressable>
		</View>
	);
};

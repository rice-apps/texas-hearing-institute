...
import { consonants,prompt2,storageKey } from './Constants';
import AsyncStorage from '@react-native-async-storage/async-storage';

// none of this might be even working, I can't access the expo share might me all trash lo
        ...
        <SafeAreaView style={{
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <ProgressBar progress={25} height={8} />
                </View>
                <View style={{
                    width: 24,
                }} />
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{marginBottom: 32}}>
                        <MarkdownText content={prompt2} fontSize={24} />
                    </View>
